    ...
    return (
      ...
      `}>
                ...
                <div className="p-6 border-b border-gray-800 flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-lg font-black text-white tracking-tight leading-none uppercase">Agence</h1>
                        <p className="text-[10px] text-green-400 font-bold tracking-widest uppercase mt-1">Aigle Royale</p>
                    </div>
                </div>
                ...
                `}
                            >
                                <span className={`${active ? 'text-white' : 'text-gray-500 group-hover:text-green-400'}`}>
                                    {item.icon}
                                </span>
                                {item.title}
                            </Link>
