export const COUNTRY_CODES = [
  ...
  'CX','CC','CO','KM','CG','CD','CK','CR','HR','CU','CW','CY','CZ','DK','DJ',
  'CI',
...
export function getCountryLabel(code: string, locale = 'fr'): string {
  try {
    // Intl.DisplayNames is widely supported on modern browsers.
    // If unavailable, fall back to the country code.
